...
namespace ACE.Server.WorldObjects
{
    partial class Player
    {
                    ...
                    else
                    {
                        ...
                        switch (xpType)
                        {
                            ...
                            case XpType.PvP:
                                ...
                                // Overflow past the PvP daily cap or global cap fills Ancient Bottles
                                var pvpBottleOverflow = addAmount - xpToAdd;
                                if (pvpBottleOverflow > 0)
                                    FillXpBottlesFromOverflow(pvpBottleOverflow);
                                break;
        ...
        /// </summary>
        public void GrantLevelProportionalXp(double percent, long min, long max, XpType xpType = XpType.Quest)
        {
            ...
            // apply xp modifiers?
            EarnXP(scaledXP, xpType, Level, null, 0, null, ShareType.Allegiance);
        }
