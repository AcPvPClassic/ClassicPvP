                ...
                if (player != null)
                {
                    ...
                    if (shouldReward)
                    {
                        switch (ActiveEvent.EventType)
                        {
                            case "1v1":
                            case "2v2":
                                player.GrantLevelProportionalXp(0.2, 0, 0, XpType.PvP);
                            ...
                            case "group":
                                ...
                                player.GrantLevelProportionalXp(groupWinXp, 0, 0, XpType.PvP);
                ...
                if (player != null)
                {
                    ...
                    if (shouldReward)
                    {
                        switch (ActiveEvent.EventType)
                        {
                            case "1v1":
                            case "2v2":
                                player.GrantLevelProportionalXp(0.05, 0, 0, XpType.PvP);
        ...
        public void EndEventTimelimitExceeded()
        {
            ...
            foreach (var arenaPlayer in ActiveEvent.Players)
            {
                ...
                if (player != null)
                {
                    ...
                    if (shouldReward)
                    {
                        player.GrantLevelProportionalXp(0.15, 1, long.MaxValue, XpType.PvP);
